...
export class StForegroundNotificationsComponent implements AfterViewInit, OnChanges, OnInit {
   ...
   private listStatusNotifications: Array<StatusNotification> = [];
   ...
   checkOneLine(): void {
      ...
      console.log('1----', this.statusValue, this.statusIconValue);
      ...
      console.log('2----', this.statusValue, this.statusIconValue);
      this.cd.detectChanges();

      console.log('3----', this.statusValue, this.statusIconValue);
   }
